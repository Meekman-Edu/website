      ...
      <section className="grid md:grid-cols-3 md:gap-6 gap-4 items-center lg:gap-10 lg:grid-cols-4">
        <div className="pr-4 col-span-2 max-w-lg">
          <p className="text-lg font-semibold">
            ...
            delivering innovative solutions that meet the evolving needs of our
            clients. With a strong commitment to excellence, we specialize in
            providing services designed to enhance performance, drive
